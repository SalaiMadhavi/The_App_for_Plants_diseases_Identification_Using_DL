...
const Home = () => {
  ...
  const onUpload = async (image) => {
    ...
    try {
      const response = await axios.post(`${BASE_URL}/api/predict`, image);
      if (response) {
            ...
            <View style={styles.innerCard}>
              ...
              <View style={{ paddingLeft: 10 }}>
                ...
                >
                  ...
                  {"    "}
                  Plant Health App Is A Plant Disease Detection Mobile
                  Application That Aids To Assist Farmers In Detecting Plant
                  Disease And Recommending Treatment.
                </Text>
              </View>
            </View>
            <View>
